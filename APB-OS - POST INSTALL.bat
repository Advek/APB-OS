@echo off
@title "APB-OS 21h2 - POST INSTALL"
...
move "C:\Setup" "C:\Users\%username%\Desktop"
move "C:\Support" "C:\Users\%username%\Desktop"
move "C:\Dark.skin7" "C:\Program Files\Open-Shell\Skins"
cls
...
Reg.exe add "HKCR\Directory\Background\shell\\APB-OS by Adv3k#4394\\command" /ve /t REG_SZ /d "explorer https://dsc.gg/apb" /f
cls
...
Reg.exe add "HKCU\Environment" /v "__COMPAT_LAYER" /t REG_SZ /d "~ DISABLEDXMAXIMIZEDWINDOWEDMODE" /f
